...
const RecentProjectUpdates = () => {
  ...
  return (
    <div className='CPCards p-3 w-[50%] flex flex-col gap-5'>
      ...
      {recentUpdates.map((items)=> {
        return <div key={items.id} className="flex justify-between border-t border-black/10 py-3">
          <div className="flex gap-5 items-center">
          <div className="bg-black/20 w-10 h-10 flex items-center justify-center rounded-sm">{items.icon}</div>
          <div>

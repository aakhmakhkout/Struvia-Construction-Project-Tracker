...
const ProjectHealth = () => {
  ...
  return (
    <div className='w-[25%] CPCards p-3 flex flex-col gap-5'>
      <div>
      ...
      <div className="flex flex-col gap-2">
        {projectHealthData.map((items)=> {
          return <div key={items.id} className="flex justify-between border border-black/10 p-[10px_5px] items-center rounded-lg">

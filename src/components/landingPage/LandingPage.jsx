...
const LandingPage = () => {
  const landingPageCards =[
    ...
    return (
    <div className='w-full min-h-screen relative bg-[url("./src/assets/Bg.jpg")] bg-cover bg-center max-md:bg-'>
      ...
      <div className='relative z-10 w-full md:h-screen max-md:min-h-screen  flex flex-col  text-white items-center'>
        ...
        <div className='w-full min-h-60 flex gap-5 items-center'>
          ...
          <div>
            <h1 className='text-8xl font-bold max-md:text-5xl max-sm:text-4xl'>STRUVIA</h1>
            <h3 className='text-3xl text-[#fdba03] max-md:text-base max-sm:text-sm'>BUILDING BETTER, TOGETHER</h3>
          </div>
        </div>
        
        <div className='flex flex-col gap-5 '>
          <h1 className='text-5xl font-extralight max-emd:text-3xl'>Welcome to <span className='font-bold text-[#fdba03]'>Struvia</span></h1>
          <span className='w-30 h-[1.5px] bg-[#fdd703]'></span>
          <p className='w-[40%] text-white/80 max-lg:w-[60%] max-md:w-[80%] max-sm:w-full'>Your all-in-one platform to track construction projects,
